...
public class HexBoundaryHighlighter : MonoBehaviour
{
    ...
    public void ShowBoundaryAt(int q0, int r0, int radius)
    {
        ...
        foreach (var kv in outerEdges)
        {
            ...
            // Mapping:
            // side 0: 30° → 330°   (corner 0 → corner 5)
            // side 1: 330° → 270°  (corner 5 → corner 4)
            // side 2: 270° → 210°  (corner 4 → corner 3)
            // side 3: 210° → 150°  (corner 3 → corner 2)
            // side 4: 150° → 90°   (corner 2 → corner 1)
            // side 5: 90° → 30°    (corner 1 → corner 0)
    ...
    {
        // use counter-clockwise ordering: angle = 60 * i + 30 (30°, 90°, 150°, 210°, 270°, 330°)
        // Pointy-top hexagon
